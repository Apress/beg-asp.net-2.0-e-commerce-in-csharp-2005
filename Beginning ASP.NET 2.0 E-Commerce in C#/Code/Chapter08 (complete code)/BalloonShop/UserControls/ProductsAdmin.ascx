...
<asp:GridView ID="grid" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductID"
  ...
  <Columns>
    <asp:ImageField DataImageUrlField="Image1FileName" DataImageUrlFormatString="../ProductImages/{0}"
    ...
    <asp:TemplateField HeaderText="Image2 File" SortExpression="Image2FileName">
      <ItemTemplate>
        <asp:Label ID="Label4" runat="server" Text='<%# Bind("Image2FileName") %>'></asp:Label>
      </ItemTemplate>
      <EditItemTemplate>
        <asp:TextBox ID="image2TextBox" Width="80px" runat="server" Text='<%# Bind("Image2FileName") %>'></asp:TextBox>
      </EditItemTemplate>
    </asp:TemplateField>
    <asp:CheckBoxField DataField="OnDepartmentPromotion" HeaderText="Dept. prom." SortExpression="OnDepartmentPromotion" />
    <asp:CheckBoxField DataField="OnCatalogPromotion" HeaderText="Cat. prom." SortExpression="OnCatalogPromotion" />
    <asp:TemplateField>
      <ItemTemplate>
